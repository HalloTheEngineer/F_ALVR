...
pub fn platform(runtime_name: Option<String>, runtime_version: Option<u64>) -> Platform {
    #[cfg(target_os = "android")]
    {
        ...
        match (
            ...
            ("Oculus" | "Meta", _, "monterey", _) => Platform::Quest1,
            ("Oculus" | "Meta", _, "hollywood", _) => Platform::Quest2,
            ("Oculus" | "Meta", _, "eureka", _) => Platform::Quest3,
            ("Oculus" | "Meta", _, "panther", _) => Platform::Quest3S,
            ("Oculus" | "Meta", _, "seacliff", _) => Platform::QuestPro,
            ("Oculus" | "Meta", _, _, _) => Platform::QuestUnknown,
